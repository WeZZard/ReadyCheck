/*
 * BenchWorkloadCApp - E2E benchmark workload for C function tracing (app bundle).
 *
 ...
 *
 * Provides bench_workload_run() which runs all patterns with default
 * parameters and prints BENCH_RESULT to stderr.
 */
...
/* ---------------------------------------------------------------------------
 * bench_workload_run - run all 4 patterns with default parameters.
 * --------------------------------------------------------------------------- */
