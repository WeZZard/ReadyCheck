...
status: active
source: docs/definitions/PLATFORM_LIMITATIONS.md
---
...
See: docs/definitions/PLATFORM_LIMITATIONS.md (archived)
```

## References

- Original: `docs/definitions/PLATFORM_LIMITATIONS.md` (archived source)
